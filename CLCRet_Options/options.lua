		...
		behavior = {
			...
			args = {
				...
				-- aoeMode = {
					...
					-- type = "toggle", 
					-- width = "full", 
					-- name = "AOE Mode - Suggest Divine Storm instead of Templar's Verdict for Two or more mobs",
					-- get = Get
					-- set = Set
					-- get = function(info) return db.aoeMode end,
					-- set = function(info, val) clcret:AoeModeToggle()
					-- end,
				-- },
