...
function clcret:OnInitialize()
	...
	-- Welcome message
	print "|cffF58CBAclcRet|r: To turn on the |cffec0000Experimental|r AOE mode, go to |cff55ff84Rotation|r > |cff55ff84Setting & AOE Mode|r > |cff55ff84Check the box|r."
